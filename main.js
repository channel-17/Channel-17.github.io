...
const CARL_HEART_PATH = [
  ...
  { left:"82.2%", top:"96%",  transform:"translate(-50%,-50%) scale(1) rotate(-0.5deg)", opacity:1, offset:.041 },
  { left:"82.0%", top:"88%",  transform:"translate(-50%,-50%) scale(1) rotate(0deg)",    opacity:1, offset:.088 },
  { left:"82.2%", top:"79%",  transform:"translate(-50%,-50%) scale(1) rotate(0.4deg)",  opacity:1, offset:.141 },
  { left:"82.0%", top:"69%",  transform:"translate(-50%,-50%) scale(1) rotate(0deg)",    opacity:1, offset:.200 },
  { left:"82.2%", top:"59%",  transform:"translate(-50%,-50%) scale(1) rotate(-0.4deg)", opacity:1, offset:.259 },
  { left:"82.0%", top:"49%",  transform:"translate(-50%,-50%) scale(1) rotate(0deg)",    opacity:1, offset:.318 },
  { left:"82.2%", top:"40%",  transform:"translate(-50%,-50%) scale(1) rotate(0.4deg)",  opacity:1, offset:.371 },
  { left:"82.0%", top:"32%",  transform:"translate(-50%,-50%) scale(1) rotate(0deg)",    opacity:1, offset:.418 },
  { left:"82.2%", top:"25%",  transform:"translate(-50%,-50%) scale(1) rotate(-0.4deg)", opacity:1, offset:.459 },
  ...
  { left:"81%",   top:"16.5%", transform:"translate(-50%,-50%) scale(1) rotate(-1deg)", opacity:1, offset:.515 },
  { left:"79.5%", top:"14.5%", transform:"translate(-50%,-50%) scale(1) rotate(-2deg)", opacity:1, offset:.535 },
  { left:"77.5%", top:"12.3%", transform:"translate(-50%,-50%) scale(1) rotate(-3deg)", opacity:1, offset:.558 },
  { left:"75%",   top:"9.8%",  transform:"translate(-50%,-50%) scale(1) rotate(-4deg)", opacity:1, offset:.586 },
  { left:"72.2%", top:"7.0%",  transform:"translate(-50%,-50%) scale(1) rotate(-5deg)", opacity:1, offset:.618 },
  { left:"69.3%", top:"4.0%",  transform:"translate(-50%,-50%) scale(1) rotate(-6deg)", opacity:1, offset:.651 },
  { left:"66.5%", top:"1%",    transform:"translate(-50%,-50%) scale(1) rotate(-7deg)", opacity:1, offset:.682 },
  { left:"64%",   top:"-3%",   transform:"translate(-50%,-50%) scale(1) rotate(-8deg)", opacity:1, offset:.710 },
